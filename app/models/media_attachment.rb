...
class MediaAttachment < ApplicationRecord
  ...
  IMAGE_MIME_TYPES             = %w(image/jpeg image/png image/gif image/webp image/heic image/heif).freeze
  IMAGE_CONVERTIBLE_MIME_TYPES = %w(image/webp image/heic image/heif).freeze
